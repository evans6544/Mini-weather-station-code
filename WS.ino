...
String network = "Dialog 4G 811";                            // your access point SSID
String password = "90!dmj135";                  // your wifi Access Point password
#define IP "184.106.153.149"                        // IP address of thingspeak.com
String GET = "GET /update?key=ZLFRZS0K56A2IXZY";    // replace with your channel key
...
void setup()
{
  ...
  esp8266Module.begin(115200);                        // Setting softserial baud rate to 9600
